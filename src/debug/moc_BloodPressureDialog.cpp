...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BloodPressureDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BloodPressureDialog_t qt_meta_stringdata_BloodPressureDialog = {
    {
QT_MOC_LITERAL(0, 0, 19) // "BloodPressureDialog"
...
QT_INIT_METAOBJECT const QMetaObject BloodPressureDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<DialogBase::staticMetaObject>(),
    qt_meta_stringdata_BloodPressureDialog.data,
...
void *BloodPressureDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::BloodPressureDialog"))
        return static_cast< Ui::BloodPressureDialog*>(this);
