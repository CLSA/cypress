...
const QMap<QString, QVariant> defaultSettings = {{
    ...
    {"dicom/host", 		 "0.0.0.0"},
    {"dicom/port", 		 9000},
    {"dicom/asc_config", "./storescp.cfg"},
    {"dicom/log_config", "./logger.cfg"},
    {"dicom/out_dir", 	 "C:/Users/Anthony/Documents/PACS"},
    {"dicom/args", 		 "--series-date-subdir --short-unique-names --filename-extension .dcm"},
    ...
    {"retinal_scan/exe", 				"C:/Program Files/Mozilla Firefox/firefox.exe"},
