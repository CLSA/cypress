...
class Ui_BloodPressureMeasurements(object):
    def setupUi(self, BloodPressureMeasurements):
        ...
        self.measureButton = QPushButton(self.groupBox)
        ...
        self.table.setFrameShadow(QFrame.Shadow.Raised)
    ...
    def retranslateUi(self, BloodPressureMeasurements):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("BloodPressureMeasurements", u"Measurements", None))
