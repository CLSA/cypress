...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.statusValue.sizePolicy().hasHeightForWidth())
        self.statusValue.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.versionValue.sizePolicy().hasHeightForWidth())
        self.versionValue.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.lastUpdatedLabel.sizePolicy().hasHeightForWidth())
        self.lastUpdatedLabel.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.lastUpdatedValue.sizePolicy().hasHeightForWidth())
        self.lastUpdatedValue.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.hostLabel.sizePolicy().hasHeightForWidth())
        self.hostLabel.setSizePolicy(sizePolicy2)

        self.horizontalLayout_3.addWidget(self.hostLabel)

        self.hostValue = QLabel(self.tab)
        self.hostValue.setObjectName(u"hostValue")
        sizePolicy3.setHeightForWidth(self.hostValue.sizePolicy().hasHeightForWidth())
        self.hostValue.setSizePolicy(sizePolicy3)
