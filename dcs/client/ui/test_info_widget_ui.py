...
class Ui_TestInfoWidget(object):
    def setupUi(self, TestInfoWidget):
        ...
        TestInfoWidget.setMinimumSize(QSize(0, 0))
        ...
        self.verticalLayout.addWidget(self.groupBox, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def retranslateUi(self, TestInfoWidget):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("TestInfoWidget", u"Stage", None))
