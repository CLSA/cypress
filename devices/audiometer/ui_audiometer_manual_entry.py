...
class Ui_AudiometerManualEntryDialog(object):
    def setupUi(self, AudiometerManualEntryDialog):
        if not AudiometerManualEntryDialog.objectName():
            AudiometerManualEntryDialog.setObjectName(u"AudiometerManualEntryDialog")
        AudiometerManualEntryDialog.resize(344, 310)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(AudiometerManualEntryDialog.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, AudiometerManualEntryDialog):
        AudiometerManualEntryDialog.setWindowTitle(QCoreApplication.translate("AudiometerManualEntryDialog", u"Manual Entry", None))
        self.leftGroup.setTitle(QCoreApplication.translate("AudiometerManualEntryDialog", u"Left Ear", None))
        self.Left500HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"500 Hz", None))
        self.Left500HzSpinBox.setSpecialValueText("")
        self.Left1000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"1000 Hz", None))
        self.Left1000HzSpinBox.setSpecialValueText("")
        self.Left2000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"2000 Hz", None))
        self.Left2000HzSpinBox.setSpecialValueText("")
        self.Left3000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"3000 Hz", None))
        self.Left3000HzSpinBox.setSpecialValueText("")
        self.Left4000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"4000 Hz", None))
        self.Left4000HzSpinBox.setSpecialValueText("")
        self.Left6000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"6000 Hz", None))
        self.Left6000HzSpinBox.setSpecialValueText("")
        self.Left8000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"8000 Hz", None))
        self.Left8000HzSpinBox.setSpecialValueText("")
        self.rightGroup.setTitle(QCoreApplication.translate("AudiometerManualEntryDialog", u"Right Ear", None))
        self.Right500HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"500 Hz", None))
        self.Right500HzSpinBox.setSpecialValueText("")
        self.Right1000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"1000 Hz", None))
        self.Right1000HzSpinBox.setSpecialValueText("")
        self.Right1000HzSpinBox.setSuffix("")
        self.Right1000HzSpinBox.setPrefix("")
        self.Right2000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"2000 Hz", None))
        self.Right2000HzSpinBox.setSpecialValueText("")
        self.Right3000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"3000 Hz", None))
        self.Right3000HzSpinBox.setSpecialValueText("")
        self.Right4000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"4000 Hz", None))
        self.Right4000HzSpinBox.setSpecialValueText("")
        self.Right6000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"6000 Hz", None))
        self.Right6000HzSpinBox.setSpecialValueText("")
        self.Right8000HzLabel.setText(QCoreApplication.translate("AudiometerManualEntryDialog", u"8000 Hz", None))
